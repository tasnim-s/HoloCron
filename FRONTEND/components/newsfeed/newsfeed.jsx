...
class Newsfeed extends React.Component {
    ...
    render() {
        ...
        if(!this.state.loading) {
            friends = Object.values(users).filter(user => currentUser.friendIds.includes(user.id));
        ...
        return this.state.loading ? <Spinner /> : (
            <div className="newsfeed">
                <Navigation />
                <Main fetchAllUsers={fetchAllUsers} currentUser={currentUser} posts={posts} createPostForm={createPostForm} deletePost={deletePost} editPost={editPost} addLike={addLike} removeLike={removeLike} createComment={createComment} editComment={editComment} deleteComment={deleteComment} users={users} />
