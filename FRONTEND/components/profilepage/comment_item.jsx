...
export default class CommentItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {hidden: true, showReplies: false, editing: false, content: this.props.comment.content};
    ...
    render() {
        const { currentUser, liked, comment: { content, commenter, id, likers}, editComment, deleteComment } = this.props;
        ...
        return (
            <div className="comment-item">
                ...
                {this.state.editing ? <input type="text" value={this.state.content} onKeyPress={this.handleKeyPress} onChange={this.handleChange}/> :
